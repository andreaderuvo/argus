...
const SCENES = {
  ...
  keep: {
    ...
    steps: [
      ...
      { say: 'Saved — and Custom lights, because this is now the arrangement you are in.', hold: 1400 },
      { click: 'button[data-mode="grid"]', hold: 1800 },
      { say: 'Any tiling throws yours away…', hold: 1200 },
      { click: '[data-mine]', hold: 2400 },
      { say: '…and Custom brings it back, windows and all.', hold: 1600 },
    ],
  },
